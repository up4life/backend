...
type Chat {
  ...
  typing(where: UserWhereInput, orderBy: UserOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [User!]
}
...
input ChatWhereInput {
  ...
  typing_every: UserWhereInput
  typing_some: UserWhereInput
  typing_none: UserWhereInput
  AND: [ChatWhereInput!]
  OR: [ChatWhereInput!]
  NOT: [ChatWhereInput!]
}
